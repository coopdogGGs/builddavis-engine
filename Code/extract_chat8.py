"""Extract chat messages from VS Code Copilot JSONL - Chat 8.
...
SRC = r'REDACTED_PATH\AppData\Roaming\Code\User\workspaceStorage\bc015ee5f3eb128bf42e6031cbcd03ba\chatSessions\5fea41c8-8dc4-47d8-9cbf-c603434088bd.jsonl'
DST = r'REDACTED_PATH\OneDrive\Vibe\BuildDavis\Chat8.txt'
...
with open(DST, 'w', encoding='utf-8') as of:
    of.write("# Chat 8: ICONIC_Davis_5 - Satellite Screenshots & Reference Images\n\n")
