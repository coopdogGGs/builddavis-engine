...
MC footprint: X=[3436,3463], Z=[5194,5240] (28W × 47D raw OSM polygon).
Simplified to axis-aligned 17W × 30D rectangle within that footprint.
Placement: X=3436, Y=49, Z=5194.
"""
...
# VARSITY lettering — 7 letters at spaced positions
for x in [2, 4, 5, 7, 8, 10, 11]:
    put(x, 8, 0, SIGN_TXT)
