"""Extract chat messages from VS Code Copilot JSONL - Chat 7.
...
SRC = r'REDACTED_PATH\AppData\Roaming\Code\User\workspaceStorage\bc015ee5f3eb128bf42e6031cbcd03ba\chatSessions\3d54d3e8-346a-4410-b99d-c5fbe4cb2387.jsonl'
DST = r'REDACTED_PATH\OneDrive\Vibe\BuildDavis\Chat7.txt'
...
with open(DST, 'w', encoding='utf-8') as of:
    of.write("# Chat 7: ICONIC-001 Image Library - Putah Creek (#24) & Continuation\n\n")
